...
public class AppOpenManager implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public static int flagShareRateMore = 0;
    ...
    SharedPreferences.Editor myEditSetting;

    SharedPreferences shSetting;
...
//        }
    ...
    public void onActivityResumed(Activity activity) {
        ...
        /*shSetting = activity.getSharedPreferences("MySharedPrefLanguage", Context.MODE_PRIVATE);
        Integer s1Language = shSetting.getInt("flagShareRateMore", 0);*/
...
//                            }
                            ...
                            showAdIfAvailable(true);
                            myEditSetting.putInt("flagShareRateMore", 1);
                            myEditSetting.commit();
                        }
                    }
    ...
    public void onResume() {
        ...
        shSetting = getInstance().currentActivity.getSharedPreferences("MySharedPrefSetting", MODE_PRIVATE);
        Integer s1Language = shSetting.getInt("flagShareRateMore", 0);

        sharedPreferencesSetting = getInstance().currentActivity.getSharedPreferences("MySharedPrefSetting", MODE_PRIVATE);
        myEditSetting = sharedPreferencesSetting.edit();

        if (s1Language == 0) {
            Log.d(TAG, "onStart: show resume ads :" + currentActivity.getClass().getName());
            showAdIfAvailable(false);
        } else {
            myEditSetting.putInt("flagShareRateMore", 0);
            myEditSetting.commit();
        }
    }
